...
export default function AdminDashboard() {
  ...
  if (isLoading) {
    console.log("AdminDashboard: Loading auth status...");
    return (
      <div className="min-h-screen flex items-center justify-center">
        <p>Loading admin dashboard...</p>
      </div>
    ); // Or a proper spinner/loader
  }

  if (!isAuthenticated) {
    console.log("AdminDashboard: Not authenticated after loading.");
    return null; // The useEffect above should handle the actual redirect.
                 // This ensures nothing renders before redirect if the effect takes a tick.
  }
